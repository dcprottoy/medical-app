...
<div class="content-wrapper">
    <x-breadcumb title="Investigation Type"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Investigation Type Entry</h3>
                </div>
                <form action="{{route('investigationtype.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
            ...
            <div class="card">
                ...
                <div class="m-3">
                    {{ $inv_types->links('pagination::bootstrap-4')}}
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Investigation Type</h4>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Investigation Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<script>
    $(document).ready(function(){
        $(".delete").on('click',function(e){
            ...
            let link = "{{url('investigationtype/')}}/"+id;
