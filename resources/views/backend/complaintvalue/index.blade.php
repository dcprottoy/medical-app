...
<div class="content-wrapper">
    <x-breadcumb title="Complaint Value"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Complaint Value Entry</h3>
                </div>
                <form action="{{route('complaintvalue.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Complaint Value Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Complaint Name">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>অভিযোগ এর মাত্রা এর নাম</label>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Complaint Value</h3>
                    ...
                    <table class="table table-sm table-striped projects">
                        <thead>
                            ...
                            <th style="width: 30%" class="text-center">
                                Complaint Value Name
                            </th>
                            <th style="width: 15%" class="text-center">
                                অভিযোগ এর মাত্রা এর নাম
                            </th>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Complaint Value</h4>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Complaint Value Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<script>
    $(document).ready(function(){
        $(".delete").on('click',function(e){
            ...
            let link = "{{url('complaintvalue/')}}/"+id;
