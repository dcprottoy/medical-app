...
<div class="content-wrapper">
    <x-breadcumb title="Previous History"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Previous History Entry</h3>
                </div>
                <form action="{{route('prevhistory.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Previous History Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Previous History Name">
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="m-3">
                    {{ $prevhistories->links('pagination::bootstrap-4')}}
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Previous History</h4>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Previous History Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Previous History Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Previous History Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label>Status</label><br>
