...
<div class="content-wrapper">
    <x-breadcumb title="Bill Reference"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Bill Reference Entry</h3>
                </div>
                <form action="{{route('billreference.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" placeholder="Reference ID" disabled>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Reference Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Reference Name">
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-0" style = "min-height:500px;">
                    <table class="table table-sm table-striped projects">
                        ...
                        <tbody>
                        @foreach($bill_references as $item)
                            <tr>
                                <td>
                                   #
                                </td>
                ...
                <div class="m-3">
                    {{ $bill_references->links('pagination::bootstrap-4')}}
                </div>
            </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Bill Reference Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Reference ID</label>
                                                <input type="text" class="form-control form-control-sm" id='u-reference-id' name='reference_id' placeholder="Reference ID" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
            ...
            let id = $(this).attr("data-id");
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#u-reference-id').val(result.reference_id);
